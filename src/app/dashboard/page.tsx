...
export default async function DashboardPage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-surface">
      ...
      {/* Dashboard Header */}
      <header className="h-16 bg-surface-container-low border-b border-outline-variant/10 flex items-center justify-between px-6 ml-20 lg:ml-64">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="label-sm text-on-surface-variant">Your Tactile Companion</p>
            </div>
          </div>
        </div>
        <div className="flex items-center gap-4">
